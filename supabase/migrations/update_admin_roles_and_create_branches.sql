-- Clean migration to update admin roles and create Vinotel branches schema
-- This migration handles existing data conflicts properly

-- First, drop the existing role constraint
ALTER TABLE public.admin_users DROP CONSTRAINT IF EXISTS admin_users_role_check;

-- Update existing admin roles to match new schema
UPDATE public.admin_users SET role = 'corporate_admin' WHERE role = 'admin';
UPDATE public.admin_users SET role = 'branch_manager' WHERE role = 'manager';
...
-- Add branch_id to rooms table if it doesn't exist
...
-- Update admin_users table to include branch reference
...
-- Insert sample Vinotel branches (only if they don't exist)
INSERT INTO public.branches (name, description, address, city, country, latitude, longitude, branch_type, amenities, images) 
SELECT 'Vinotel Grand Palace', 'Luxury branch in the heart of the city with world-class amenities and exceptional service.', '123 Grand Avenue', 'New York', 'USA', 40.7589, -73.9851, 'luxury', '["WiFi", "Pool", "Spa", "Gym", "Restaurant", "Bar", "Concierge", "Valet Parking"]', '["https://images.unsplash.com/photo-1566073771259-6a8506099945", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b"]'
WHERE NOT EXISTS (SELECT 1 FROM public.branches WHERE name = 'Vinotel Grand Palace');

INSERT INTO public.branches (name, description, address, city, country, latitude, longitude, branch_type, amenities, images) 
SELECT 'Vinotel Seaside Resort', 'Beachfront resort branch with stunning ocean views and premium facilities.', '456 Ocean Drive', 'Miami', 'USA', 25.7617, -80.1918, 'resort', '["WiFi", "Beach Access", "Pool", "Restaurant", "Water Sports", "Spa", "Bar"]', '["https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9", "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4"]'
WHERE NOT EXISTS (SELECT 1 FROM public.branches WHERE name = 'Vinotel Seaside Resort');

INSERT INTO public.branches (name, description, address, city, country, latitude, longitude, branch_type, amenities, images) 
SELECT 'Vinotel Business Center', 'Modern business branch with state-of-the-art conference facilities.', '789 Business Blvd', 'San Francisco', 'USA', 37.7749, -122.4194, 'business', '["WiFi", "Business Center", "Gym", "Restaurant", "Meeting Rooms", "Conference Facilities"]', '["https://images.unsplash.com/photo-1564501049412-61c2a3083791", "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa"]'
WHERE NOT EXISTS (SELECT 1 FROM public.branches WHERE name = 'Vinotel Business Center');

-- Update existing rooms to reference the first branch (Grand Palace)
...
-- Update admin users to assign branch managers to branches (optional)
UPDATE public.admin_users 
SET branch_id = (SELECT id FROM public.branches WHERE name = 'Vinotel Grand Palace' LIMIT 1)
WHERE role = 'branch_manager' AND branch_id IS NULL;