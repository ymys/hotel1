...
import { Search, MapPin, Star, Users, Calendar, Shield, Award, Clock, ArrowRight, Quote } from 'lucide-react';
  ...
  const featuredBranches: Branch[] = [
    {
      ...
      price: 299,
      originalPrice: 399,
      image: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=luxury%20vinotel%20hotel%20exterior%20grand%20palazzo%20style%20architecture%20elegant%20facade%20golden%20hour&image_size=landscape_4_3',
    ...
    {
      id: '2',
      name: 'Vinotel Oceanview Resort',
      location: 'Miami Beach, FL',
      rating: 4.9,
      reviewCount: 892,
      price: 249,
      image: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=beachfront%20vinotel%20resort%20hotel%20ocean%20view%20tropical%20paradise%20palm%20trees%20sunset&image_size=landscape_4_3',
      amenities: ['wifi', 'parking', 'restaurant', 'gym'],
    ...
    },
    {
      ...
      price: 189,
      originalPrice: 259,
      image: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=mountain%20vinotel%20lodge%20hotel%20snow%20capped%20peaks%20cozy%20cabin%20style%20winter%20wonderland&image_size=landscape_4_3',
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Absolutely incredible experience! The booking process was seamless and the branch exceeded all expectations. Will definitely use Vinotel again.',
    ...
    },
    {
      ...
      rating: 5,
      comment: 'The best branch booking platform I\'ve used. Great prices, amazing selection, and excellent customer service. Highly recommended!',
    ...
    },
    {
      ...
      location: 'Chicago, IL',
      rating: 5,
      comment: 'Found the perfect Vinotel branch for our anniversary trip. The photos were accurate and the booking process was so easy. Thank you Vinotel!',
  ...
  const features = [
    {
      ...
      description: 'Handpicked luxury Vinotel branches and resorts worldwide'
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=luxury%20vinotel%20branch%20lobby%20elegant%20interior%20marble%20columns%20crystal%20chandelier%20warm%20lighting%20sophisticated%20atmosphere&image_size=landscape_16_9"
            alt="Luxury Vinotel Branch Lobby"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-12 text-gray-200 max-w-3xl mx-auto leading-relaxed">
              Experience world-class hospitality with our curated selection of premium Vinotel branches and resorts. Your journey to luxury begins here.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We're committed to providing you with the finest Vinotel branch booking experience
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Featured Branches</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our handpicked selection of luxury Vinotel accommodations
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {featuredBranches.map((branch) => (
              <BranchCard key={branch.id} branch={branch} variant="featured" />
            ))}
          </div>
